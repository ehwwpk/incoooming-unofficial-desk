...
OPEN_CALL_METRICS = {
    ...
    for item in (
        ...
        OpenCallMetricFixture("CVX", date(2026, 9, 18), D("230"), D("1.80"), D("-0.035")),
        OpenCallMetricFixture("KTOS", date(2026, 9, 18), D("65"), D("3.30"), D("-0.065")),
        OpenCallMetricFixture("KTOS", date(2026, 9, 18), D("75"), D("1.10"), D("-0.045")),
